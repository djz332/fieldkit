The version of the code and coords.npy array generated are sepecifically for random walk only. Certain calculations and sections of the generic code are deleted for slimplicity.
